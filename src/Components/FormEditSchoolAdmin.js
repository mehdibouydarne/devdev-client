...
const FormEditSchoolAdmin = () => {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_HOST}/school/${id}`, { headers: authHeader() })
            .then((res) => {
                setSchool(res.data);
    ...
    const handleSubmit = (e) => {
        ...
        if (user) {
            if (user.isAdmin) {
                axios
                    .put(
                        `${process.env.REACT_APP_HOST}/school/admin-edit-school/${id}`,
                        formData,
                        {
                            headers: authHeader(),
                        }
...
export default FormEditSchoolAdmin;
