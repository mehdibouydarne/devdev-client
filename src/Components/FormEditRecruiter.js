...
const FormEditRecruiters = () => {
    ...
    useEffect(() => {
        if (user) {
            axios
                .get(`${process.env.REACT_APP_HOST}/recruiter/${user.id}`, {
                    headers: authHeader(),
                })
                .then((res) => {
                    console.log(user);
    ...
    const handleSubmit = (e) => {
        ...
        if (user) {
            axios
                .put(
                    `${process.env.REACT_APP_HOST}/recruiter/edit-recruiter/${user.id}`,
                    formData,
                    {
                        headers: authHeader(),
                    }
...
export default FormEditRecruiters;
